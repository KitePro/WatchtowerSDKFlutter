...
class AppStartPayload extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set appStartTimestamp($2.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(5)
  set gaid($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set idfa($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set oaid($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set fcmToken($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set hmsToken($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(9)
