...
const PostEventRequst$json = const {
  '1': 'PostEventRequst',
  '2': const [
    const {'1': 'event', '3': 1, '4': 1, '5': 11, '6': '.watch_tower_proto.Event', '10': 'event'},
  ],
};

/// Descriptor for `PostEventRequst`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List postEventRequstDescriptor = $convert.base64Decode('Cg9Qb3N0RXZlbnRSZXF1c3QSLgoFZXZlbnQYASABKAsyGC53YXRjaF90b3dlcl9wcm90by5FdmVudFIFZXZlbnQ=');
...
final $typed_data.Uint8List postEventResponseDescriptor = $convert.base64Decode('ChFQb3N0RXZlbnRSZXNwb25zZQ==');
@$core.Deprecated('Use postBatchEventRequstDescriptor instead')
const PostBatchEventRequst$json = const {
  '1': 'PostBatchEventRequst',
  '2': const [
    const {'1': 'batchEvent', '3': 1, '4': 1, '5': 11, '6': '.watch_tower_proto.BatchEvent', '10': 'batchEvent'},
  ],
};

/// Descriptor for `PostBatchEventRequst`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List postBatchEventRequstDescriptor = $convert.base64Decode('ChRQb3N0QmF0Y2hFdmVudFJlcXVzdBI9CgpiYXRjaEV2ZW50GAEgASgLMh0ud2F0Y2hfdG93ZXJfcHJvdG8uQmF0Y2hFdmVudFIKYmF0Y2hFdmVudA==');
...
final $typed_data.Uint8List postBatchEventResponseDescriptor = $convert.base64Decode('ChZQb3N0QmF0Y2hFdmVudFJlc3BvbnNl');
