...
const PostBatchEventRequst$json = {
  ...
  '2': [
    {'1': 'batchEvent', '3': 1, '4': 1, '5': 11, '6': '.watch_tower_proto.BatchEvent', '10': 'batchEvent'},
  ],
};
...
final $typed_data.Uint8List postBatchEventRequstDescriptor = $convert.base64Decode(
    'ChRQb3N0QmF0Y2hFdmVudFJlcXVzdBI9CgpiYXRjaEV2ZW50GAEgASgLMh0ud2F0Y2hfdG93ZX'
    'JfcHJvdG8uQmF0Y2hFdmVudFIKYmF0Y2hFdmVudA==');
