...
class Event extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Event_EVENT_TYPE>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'eventType',
        $pb.PbFieldType.OE,
        defaultOrMaker: Event_EVENT_TYPE.UNKNOWN,
        valueOf: Event_EVENT_TYPE.valueOf,
        enumValues: Event_EVENT_TYPE.values)
    ..aOM<$3.AppStartPayload>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'appStartPayload',
        subBuilder: $3.AppStartPayload.create)
    ..aOM<$3.LogPayload>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'logPayload',
        subBuilder: $3.LogPayload.create)
    ..aOM<$3.OpenLinkPayload>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'openLinkPayload',
        subBuilder: $3.OpenLinkPayload.create)
    ..aOM<$3.CustomPayload>(
        11,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'customPayload',
        subBuilder: $3.CustomPayload.create)
    ..aOS(
        12,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(6)
  set eventTimestamp($2.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set eventType(Event_EVENT_TYPE v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(8)
  set appStartPayload($3.AppStartPayload v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(10)
  set openLinkPayload($3.OpenLinkPayload v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(11)
  set customPayload($3.CustomPayload v) {
    setField(11, v);
  }
...
class BatchEvent extends $pb.GeneratedMessage {
  ...
  factory BatchEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BatchEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BatchEvent copyWith(void Function(BatchEvent) updates) =>
      super.copyWith((message) => updates(message as BatchEvent))
          as BatchEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BatchEvent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BatchEvent>(create);
