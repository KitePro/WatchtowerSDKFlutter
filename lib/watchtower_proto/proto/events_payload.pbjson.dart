...
const AppStartPayload$json = const {
  ...
  '2': const [
    const {
      '1': 'app_start_timestamp',
      '3': 1,
      '4': 1,
      '5': 11,
      '6': '.google.protobuf.Timestamp',
      '10': 'appStartTimestamp'
    },
...
final $typed_data.Uint8List appStartPayloadDescriptor = $convert.base64Decode(
    '');
...
const LogPayload$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.watch_tower_proto.LogPayload.LOG_LEVEL',
      '10': 'level'
    },
...
final $typed_data.Uint8List logPayloadDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List openLinkPayloadDescriptor = $convert.base64Decode(
    'Cg9PcGVuTGlua1BheWxvYWQSEAoDdXJpGAEgASgJUgN1cmkSIwoNcmVzcG9uc2VfY29kZRgCIAEoBVIMcmVzcG9uc2VDb2RlEiMKDXJlc3BvbnNlX3RleHQYAyABKAlSDHJlc3BvbnNlVGV4dA==');
